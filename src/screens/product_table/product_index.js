...
const columns = [
    { headerName: "ProductId", field: "ProductId", flex: 1 },
    { headerName: "ProductCode", field: "ProductCode", flex: 1 },
    { headerName: "ProductName", field: "ProductName", flex: 1 },
    { headerName: "SelectedFeePlan", field: "FeePlanName", flex: 1 },
    { headerName: "Currency", field: "Currency", flex: 1 },
    { headerName: "ProductFamily", field: "ProductFamily", flex: 1 },
];
...
const Component = (props) => {
    ...
    const FetchResults = async () => {
        ...
        await Api.GetProductsMulti(query, "SelectedFeePlan")
            .then(async (res) => {
                if (res.status) {
                    _rows = res.values || [];
                    if (_rows.length > 0) {
                        _rows.forEach(x => {
                            ...
                            x.FeePlanName = x.SelectedFeePlan?.FeePlanName || 'NA';
